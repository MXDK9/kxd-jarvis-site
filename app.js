...
async function boot() {
    const steps = [
        [15, 'Syncing Encryption Protocols...'],
        [35, 'Establishing Neural Uplink...'],
        [55, 'Loading Knowledge Matrix...'],
        [75, 'Calibrating Holographic HUD...'],
        [90, 'Diagnostic Scan: OPTIMAL'],
        [100, 'J.A.R.V.I.S. ONLINE']
    ];
